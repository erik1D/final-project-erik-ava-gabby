function LearnIS() {
    return (
        <div className="bg-[#FFF8E5] font-google-sans p-[30px] select-none shadow-2xl mt-5 mx-auto rounded-lg max-w-4xl">
            <h1 className="text-4xl font-bold mb-4 text-center">What Is Imposter Syndrome?</h1>
            <p className="text-xl italic text-gray-700 text-center mb-8">Imposter syndrome is a psychological pattern where individuals doubt their accomplishments and have a persistent fear of being exposed as a fraud.</p>
