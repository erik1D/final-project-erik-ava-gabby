    ...
    return(
        <div>
            <form action="" className="m-4">
                <textarea name="Biography" id="" placeholder="Edit Bio Here..." className="bg-[#FFE499] caret-[#997000] resize-none h-[150px] w-[400px] rounded-2xl p-3 focus:outline-3 outline-[#FFC933]"></textarea>
                <br />
