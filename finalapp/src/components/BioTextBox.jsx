    ...
    return(
        <div>
            <form action="" className="m-4">
                ...
                <br />
                <input type="submit" value="Save" className="bg-[#FFE499] rounded-2xl w-[70px] mt-4 cursor-pointer transition duration-150 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-[#FFC933]"/>
            </form>
        </div>
    );
}
